	    ...
	    <table class="table table-striped table-bordered table-condensed list">
	        ...
	        <tbody>
	            ...
	            <tr>
	                ...
	                <td width="500">
	                    <input id="nikename" name="nikename" value="${teacher.nikename}" type="text" />
	                </td>
	                <td>密码<font color="FF0000">*</font></td>
	                <td>
	                    <input id="address" name="password" value="${teacher.password }" type="text" />
	                </td>
	            </tr>
	            ...
	            <tr>
	            	<td width="500">电话号码<font color="FF0000">*</font></td>
	              	<td width="500">
	                    <input id="phone" name="phone" value="${teacher.phone }" type="text" />
	                </td>
	                <td width="15%">邮箱<font color="FF0000">*</font></td>
	                <td width="500">
	                    <input name="exmail" value="${teacher.exmail }" type="text" />
	                </td>
	            </tr>
	            ...
	            <tr>
	             ...
	             <tr>
	               ...
	               <td>
	                    <input type="radio" name="status" ${teacher.status eq 1 ? "checked":"" } value="1"/>正常
	                    <input type="radio" name="status" ${teacher.status eq 2 ? "checked":"" } value="2"/>离职
	                    <input type="radio" name="status" ${teacher.status eq 3 ? "checked":"" } value="3"/>停职
	                </td>
	            
	            <td>描述</td>
	            <!--   岗位  -->   
	             <td><input type="hidden" name="position" id="position" value="${teacher.position }"/>
	             <textarea id="description" class="form-control" rows="3" name="description" >${teacher.description}</textarea>
